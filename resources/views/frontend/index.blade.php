...
@section('content')
    ...
    <div class="home-banner-area" style="background: #8f165b;">
        <div class="container">
            <div class="row gutters-10 position-relative">
                <div class="col-lg-2 position-static d-none d-lg-block" style="margin-right: 0px !important;padding: 0px !important;">
                    @include('frontend.partials.category_menu')
                </div>
                <div class="col-lg-10" style="margin-right: 0px !important;padding: 0px !important;">
